  ...
  <footer class="site-footer">
    <div class="footer-container">
      <div class="social-icons">
        <!-- INSTAGRAM ICON -->
        <a href="https://www.instagram.com/rizkiands/" class="social-icon-link" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
        ...
        <!-- LINKEDIN ICON -->
        <a href="https://www.linkedin.com/in/rizkian-dili-septyanto/" class="social-icon-link" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
        ...
        <!-- GITHUB ICON -->
        <a href="https://github.com/RizkianDS" class="social-icon-link" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
      ...
      <p class="copyright-text">&copy; 2025 RDS. All Rights Reserved.</p>
    </div>
  </footer>
</template>
...
.site-footer {
  ...
  padding: 4rem 2rem;
  text-align: center;
  border-top: 1px solid #2d3748; /* Subtle separator line */
}
